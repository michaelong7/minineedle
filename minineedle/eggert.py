...
class WatermanEggert(SmithWaterman[ItemToAlign]):
    """
    ...
    def k_align(self, kbest: int) -> None:
        """
        Performs k Waterman-Eggert alignments with the given sequences and the
    ...
    def _align(self) -> None:
        """
        Performs a Waterman-Eggert alignment with the given sequences and the
        corresponding ScoreMatrix.
        """
    ...
    def _get_last_cell_position(self) -> tuple[int, int]:
        ...
        for Smith-Waterman / Waterman-Eggert will be the cell with the highest score.
        """
        imax, jmax = 0, 0
        max_score = 0
